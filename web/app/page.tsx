...
export default function Home() {
  ...
  return <div className="workspace-shell">
    ...
    <section className="system-strip" aria-label="平台状态"><span><i className="online-dot" />平台运行正常</span><span>2 台设备已连接</span><span>工作日 · 2026年8月31日</span><strong>当前为演示数据 · 已预留 JSON 与数据库接入边界</strong></section>
